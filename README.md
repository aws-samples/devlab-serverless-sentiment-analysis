...
![main_arch](./images/arch_diagram.jpg)
...
* Find the 'Run serverless data pipeline' entry and click the 'Open IDE' button
...
* If this is the first time you have used QuickSight in this account, you are prompted to create an account. When prompted **Click Sign up for QuickSight**. 
...
* Choose database "default" and table "movie_review_score" created earlier in Amazon Athena. Click **Select**. 
      ![main_arch](./images/select_table.png)
